...
class WC_Catalog_Restrictions_Location_Picker_Widget extends WP_Widget {
	 ...
	 * @return void
	 */
	function WC_Catalog_Restrictions_Location_Picker_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget('widget_location_picker', $this->woo_widget_name, $widget_ops);
	}
	...
	function form($instance) {
		...
		<p><label for="<?php echo $this->get_field_id('location_not_set_title'); ?>"><?php _e('Location not set title:', 'woocommerce') ?></label>
			<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('location_not_set_title')); ?>" name="<?php echo esc_attr($this->get_field_name('location_not_set_title')); ?>" value="<?php if (isset($instance['location_not_set_title'])) echo esc_attr($instance['location_not_set_title']);
		else echo __('Choose your location', 'wc_catalog_restrictions'); ?>" /></p>

		<p><label for="<?php echo $this->get_field_id('location_set_title'); ?>"><?php _e('Logged set title:', 'woocommerce') ?></label>
			<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('location_set_title')); ?>" name="<?php echo esc_attr($this->get_field_name('location_set_title')); ?>" value="<?php if (isset($instance['location_set_title'])) echo esc_attr($instance['location_set_title']);
		else echo __('Current location is %s', 'wc_catalog_restrictions'); ?>" /></p>
